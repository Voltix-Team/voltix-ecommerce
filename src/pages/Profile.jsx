        ...
        <main className="max-w-6xl mx-auto px-6 py-12 bg-[#F8FAFC] min-h-screen">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-6">
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight">{user.username}</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                    <div className="flex justify-between items-center mb-8">
                        ...
                        <Button variant="icon" onClick={openModal} className="text-[#0066FF] hover:text-blue-800">
                            <Edit size={20} strokeWidth={2.5} />
                        </Button>
                    </div>
                    <div className="space-y-6">
                        <div><p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Username</p><p className="font-medium">{user.username}</p></div>
                        ...
                        <div>
                            ...
                            {user.phone ? <p className="font-medium">{user.phone}</p> : (
                                <Button variant="plain" onClick={openModal} className="text-blue-600 text-sm font-semibold hover:underline">Add phone number</Button>
                            )}
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div className="text-gray-700 font-medium leading-relaxed">
                            {addressParts.length > 0 ? addressParts.map((line, i) => <p key={i}>{line}</p>) : (
                                <Button variant="plain" onClick={openModal} className="text-blue-600 text-sm font-semibold hover:underline">Add shipping address</Button>
                            )}
                        </div>
                    </div>
                </div>
