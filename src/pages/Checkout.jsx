                        ...
                        <div className="grid grid-cols-2 gap-3 mb-6">
                            <Button
                                ...
                                <div className="text-left">
                                    <p className={`text-sm font-bold ${paymentMethod === 'card' ? 'text-blue-600' : 'text-gray-700'}`}>Credit Card</p>
                            ...
                            <Button
                                ...
                                <div className="text-left">
                                    <p className={`text-sm font-bold ${paymentMethod === 'cash' ? 'text-blue-600' : 'text-gray-700'}`}>Cash on Delivery</p>
